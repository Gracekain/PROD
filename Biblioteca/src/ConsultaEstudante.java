...
public class ConsultaEstudante extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Title 1", "Title 3", "Title 4", "Título 4", "Título 5", "Título 6", "Título 7"
            }
        ));
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        if (linhaSelecionada != -1) {
            ...
            String Year = "";
            String Semester = "";
            Name = jTable1.getValueAt(linhaSelecionada, 1).toString();
            Father = jTable1.getValueAt(linhaSelecionada, 2).toString();
            Course = jTable1.getValueAt(linhaSelecionada, 3).toString();
            Branch = jTable1.getValueAt(linhaSelecionada, 4).toString();
            Year = jTable1.getValueAt(linhaSelecionada, 5).toString();
            Semester = jTable1.getValueAt(linhaSelecionada, 6).toString();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsultaEstudante.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ConsultaEstudante().setVisible(true);
            }
        });
    }
